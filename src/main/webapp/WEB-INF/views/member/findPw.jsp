...
<body>
    ...
    <div class="container1">
        ...
        <div class="divide2">
            ...
            <div class="divide4"><input type="text" placeholder="아이디 입력" size="35"></div>
            <div class="divide4"><input type="text" placeholder="이메일 입력" size="35"><button id="email-authentication-btn">인증번호 전송</button></div>

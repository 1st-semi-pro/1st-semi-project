...
@WebServlet("/board/findCompanionWrite") // 글쓰기 onclick="location.href='write?mode=insert&type=${param.type}'"
public class FindCompanionWriteController extends HttpServlet {
	...
	// 수정, 삭제 받기
		...
		protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
			...
			try {
				...
				String path = "/WEB-INF/views/board/findCompanionWriteForm.jsp";

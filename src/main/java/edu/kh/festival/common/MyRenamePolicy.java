...
public class MyRenamePolicy implements FileRenamePolicy{
	...
	public File rename(File originalFile) {
		...
		// 1970년 1월 1일 오전 9시부터 현재 시간까지의 경과한 ms를 반환한다.
	      ...
	      String str = "_" + String.format("%05d", ranNum);
	      					// user.png
	      					// 2023 07 25 10 25 17_000123.png // 확장자(png)는 유지되어야 함. 아래 코드
	      ...
	      int dot = name.lastIndexOf("."); // 마지막 점(.)

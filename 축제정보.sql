...
INSERT INTO INFO_BOARD	VALUES(	1	,'	"성·결혼·가족의 가치와 윤리를 중심으로 저출산·고령화 정책과 성교육을 촉구하고, 그 문화를 확산시키기 위하여 K-Family Festival in Seoul 2023(서울K가족축제)를 개최한다.
가족의 가치와 의미를 되살리는 서울K가족축제에는 10여개 이상의 시민사회단체들이 협력하며 축제를 준비한다.
각 나라의 문화권별 결혼과 가족에 대한 모습을 공유하고, 한국 사회에 만연한 저출산·고령화 문제의 심각성과 이를 해결하기 위한 다양한 정책 제안 토크콘서트를 비롯해 가족이 함께 즐길 수 있는 다양한 참여 프로그램이 준비된다. 아울러 다양한 공연과 체험형 부스도 준비되어 있으며, 어린이부터 노년층까지 모든 연령층이 즐길 수 있는 프로그램들로 채워진다.축제와 관련해서는 저출산·고령화 문제 해결을 위한 가족 정책 공모전, 행복한 가족사진 공모전도 진행된다."	,

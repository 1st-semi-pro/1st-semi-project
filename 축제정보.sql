...
INSERT INTO INFO_BOARD	VALUES(	22	,	'대전효문화뿌리축제'	,	'대전효문화뿌리축제는 천혜의 자연환경 속에 위치한 뿌리공원, 한국족보박물관, 효문화마을, 효문화진흥원을 아우르는 효문화 인프라로 효의 가치와 의미를 경험하며 자신의 뿌리를 찾아보고 가족의 정을 느낄 수 있는 축제이다. 전국에 어르신과 청소년, 그리고 3대가 함께 어울리며 즐길 수 있는 축제의 장이 되어 전국에 효 실천 문화 확산 계기를 마련하고자 한다.'	,	'2023.10.13 ~ 2023.10.15'	,	920	,	'대전 중구 뿌리공원로 79 뿌리공원'	,	'가족'	,	1)	;

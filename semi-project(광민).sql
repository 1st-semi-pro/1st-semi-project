    ...
    FOR I IN 1..180 LOOP
       ...
       INSERT INTO FESTIVAL_DETAIL
        VALUES(SEQ_FESTIVALDETAIL_NO.NEXTVAL,
              '해당 축제 상세내용', ' 해당 축제 슬로건', '전화번호', '무료', null , '해당 축제 관련 기관', null
       );
...
-----------------------------------------------------------------------------------
ALTER TABLE BOARD ADD FESTIVAL_NO NUMBER;

ALTER TABLE FESTIVAL_DETAIL
MODIFY(FESTIVAL_FREE_FL VARCHAR2(300));

ALTER TABLE FESTIVAL_DETAIL
MODIFY(FESTIVAL_SLOGAN VARCHAR2(300));
...
CREATE SEQUENCE SEQ_CO_NO
       ...
       START WITH 1 -- 시작값
       MINVALUE 1; -- 최솟값
UPDATE BOARD SET FESTIVAL_NO = SEQ_CO_NO.NEXTVAL WHERE BOARD_NO BETWEEN 1541 AND 1640;
COMMIT;
